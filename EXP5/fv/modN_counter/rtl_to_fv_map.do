...
# Generated on: Fri Mar 21 10:55:49 IST 2025 (Fri Mar 21 05:25:49 UTC 2025)
...
set logfile fv/modN_counter/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/modN_counter -revised fv_map
...
elaborate_design -golden -root {modN_counter} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/modN_counter/fv_map.v.gz
elaborate_design -revised -root {modN_counter}
...
#add_name_alias fv/modN_counter/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.modN_counter.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.modN_counter.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.modN_counter.rtl.fv_map.rpt
